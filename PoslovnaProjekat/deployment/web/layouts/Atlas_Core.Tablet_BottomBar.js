...
const region$Main = [
    <$ScrollContainer key="l26.Atlas_Core.Tablet_BottomBar.layoutContainer"
        $widgetId="l26.Atlas_Core.Tablet_BottomBar.layoutContainer"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l26.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
                    $widgetId="l26.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l26.Atlas_Core.Tablet_BottomBar.Main"
                    $widgetId="l26.Atlas_Core.Tablet_BottomBar.Main"
