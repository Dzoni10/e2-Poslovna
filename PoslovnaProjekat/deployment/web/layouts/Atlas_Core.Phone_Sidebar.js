...
const region$Main = [
    <$ScrollContainer key="l17.Atlas_Core.Phone_Sidebar.scrollContainer1"
        $widgetId="l17.Atlas_Core.Phone_Sidebar.scrollContainer1"
        ...
        top={{
            "enabled": true,
            "content": [
                <$Header key="l17.Atlas_Core.Phone_Sidebar.header1"
                    $widgetId="l17.Atlas_Core.Phone_Sidebar.header1"
                    ...
                    leftWidgets={[
                        <$SidebarToggle key="l17.Atlas_Core.Phone_Sidebar.sidebarToggle2"
                            $widgetId="l17.Atlas_Core.Phone_Sidebar.sidebarToggle2"
                            buttonId={"l17.Atlas_Core.Phone_Sidebar.sidebarToggle2"}
                            renderType={"link"}
                    ...
                    rightWidgets={[
                        <$Placeholder key="l17.Atlas_Core.Phone_Sidebar.HeaderRight"
                            $widgetId="l17.Atlas_Core.Phone_Sidebar.HeaderRight"
        ...
        left={{
            "enabled": true,
            "content": [
                <$Container key="l17.Atlas_Core.Phone_Sidebar.container1"
                    $widgetId="l17.Atlas_Core.Phone_Sidebar.container1"
                    ...
                    onClick={undefined}
                    content={[
                        <$Image key="l17.Atlas_Core.Phone_Sidebar.image1"
                            $widgetId="l17.Atlas_Core.Phone_Sidebar.image1"
                            datasource={"image"}
                            ...
                            style={undefined}
                            tabIndex={undefined} />,
                        <$Text key="l17.Atlas_Core.Phone_Sidebar.text1"
                            $widgetId="l17.Atlas_Core.Phone_Sidebar.text1"
                    ...
                    ariaHidden={false} />,
                <$NavigationTree key="l17.Atlas_Core.Phone_Sidebar.navigationTree1"
                    $widgetId="l17.Atlas_Core.Phone_Sidebar.navigationTree1"
        ...
        center={{
            "content": [
                <$Placeholder key="l17.Atlas_Core.Phone_Sidebar.Main"
                    $widgetId="l17.Atlas_Core.Phone_Sidebar.Main"
                    content={PlaceholderProperty({
