...
const region$Main = [
    <$ScrollContainer key="l20.Atlas_Core.Tablet_Split_Left.layoutContainer"
        $widgetId="l20.Atlas_Core.Tablet_Split_Left.layoutContainer"
        ...
        top={{
            "enabled": true,
            "content": [
                <$Header key="l20.Atlas_Core.Tablet_Split_Left.header1"
                    $widgetId="l20.Atlas_Core.Tablet_Split_Left.header1"
                    ...
                    leftWidgets={[
                        <$Placeholder key="l20.Atlas_Core.Tablet_Split_Left.HeaderLeft"
                            $widgetId="l20.Atlas_Core.Tablet_Split_Left.HeaderLeft"
                            content={PlaceholderProperty({
                                "id": "Atlas_Core.Tablet_Split_Left.HeaderLeft"
                            })} />
                    ]}
                    rightWidgets={[
                        <$Placeholder key="l20.Atlas_Core.Tablet_Split_Left.HeaderRight"
                            $widgetId="l20.Atlas_Core.Tablet_Split_Left.HeaderRight"
                            content={PlaceholderProperty({
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l20.Atlas_Core.Tablet_Split_Left.simpleMenuBar1"
                    $widgetId="l20.Atlas_Core.Tablet_Split_Left.simpleMenuBar1"
        ...
        left={{
            "enabled": true,
            "content": [
                <$Placeholder key="l20.Atlas_Core.Tablet_Split_Left.Left"
                    $widgetId="l20.Atlas_Core.Tablet_Split_Left.Left"
                    content={PlaceholderProperty({
        ...
        center={{
            "content": [
                <$Placeholder key="l20.Atlas_Core.Tablet_Split_Left.Main"
                    $widgetId="l20.Atlas_Core.Tablet_Split_Left.Main"
                    content={PlaceholderProperty({
