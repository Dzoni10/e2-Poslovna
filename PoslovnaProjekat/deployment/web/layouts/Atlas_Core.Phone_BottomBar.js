...
const region$Main = [
    <$ScrollContainer key="l15.Atlas_Core.Phone_BottomBar.scrollContainer1"
        $widgetId="l15.Atlas_Core.Phone_BottomBar.scrollContainer1"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l15.Atlas_Core.Phone_BottomBar.simpleMenuBar1"
                    $widgetId="l15.Atlas_Core.Phone_BottomBar.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l15.Atlas_Core.Phone_BottomBar.Main"
                    $widgetId="l15.Atlas_Core.Phone_BottomBar.Main"
