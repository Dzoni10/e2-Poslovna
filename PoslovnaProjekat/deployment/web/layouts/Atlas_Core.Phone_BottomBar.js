...
const region$Main = [
    <$ScrollContainer key="l14.Atlas_Core.Phone_BottomBar.scrollContainer1"
        $widgetId="l14.Atlas_Core.Phone_BottomBar.scrollContainer1"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l14.Atlas_Core.Phone_BottomBar.simpleMenuBar1"
                    $widgetId="l14.Atlas_Core.Phone_BottomBar.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l14.Atlas_Core.Phone_BottomBar.Main"
                    $widgetId="l14.Atlas_Core.Phone_BottomBar.Main"
