import { asProperty, fromConstant$, ensureAttributeId, registerAttributeType, getEntityMeta, registerFilterAttribute, LogManager, getAttribute$, fromComputation$, flatMapL, Access, toFriendlyId, unavailable, available, getOrElseL, asReloadable$, getObjectsByPath$, getObjectByPath$ } from './index-DZt3m621.js';
import { registerSortingAttribute, listItemProperty } from './CTcC6PjV-aKLD4G0H.js';
import { createFormatter, createUniverse } from './D5tDSKpV-ByBhIBck.js';
