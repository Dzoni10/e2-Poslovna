<<<<<<<< HEAD:PoslovnaProjekat/deployment/web/dist/D5tDSKpV-NCto3GtK.js
import { FormatterType, formatDate, parseDate, getDateFormatPlaceholder, translateEnumeration, formatNumber, parseNumber, getAttributeType, getAttributeEnumerationType, ensure, formatValue, translate, mapValues, isStoreVariableSource, crash, readUntracked, attributeToClientValue, validate, validation, evaluateFormExpression, useValue, pageScope, getPreviousValue$, withSideEffect$, fromComputation$, handleError, toFriendlyId, dependOnSubscription, LogManager, asProperty, asReloadable$, getActionArguments$, action, assertIsAttributeValue, comparer, getOrElseL, ValidationError, getSubscribedObjectState$, getObjectsByPath$, getAttribute$, flatMapL, Access, unavailable, available, getFormExpressionResultFromStore$, fromConstant$, getObjectByPath$, mapL, getOrCrashL, getEnumerationOptions } from './index-JDXCDs53.js';
import { executeAction } from './ActionButton-CnZtpka2.js';
import { runActionInComputed } from './uEIG9e6s-D5bs4rlT.js';
========
import { FormatterType, formatDate, parseDate, getDateFormatPlaceholder, translateEnumeration, formatNumber, parseNumber, getAttributeType, getAttributeEnumerationType, ensure, formatValue, translate, mapValues, isStoreVariableSource, crash, readUntracked, attributeToClientValue, validate, validation, evaluateFormExpression, useValue, pageScope, getPreviousValue$, withSideEffect$, fromComputation$, handleError, toFriendlyId, dependOnSubscription, LogManager, asProperty, asReloadable$, getActionArguments$, action, assertIsAttributeValue, comparer, getOrElseL, ValidationError, getSubscribedObjectState$, getObjectsByPath$, getAttribute$, flatMapL, Access, unavailable, available, getFormExpressionResultFromStore$, fromConstant$, getObjectByPath$, mapL, getOrCrashL, getEnumerationOptions } from './index-DRM94Sf-.js';
import { executeAction } from './ActionButton-Vn_V_FOy.js';
import { runActionInComputed } from './BkqAssms-a3v8x28y.js';
>>>>>>>> feat/sales-domain:PoslovnaProjekat/deployment/web/dist/77kgvjgm-Ckrt0mx6.js
