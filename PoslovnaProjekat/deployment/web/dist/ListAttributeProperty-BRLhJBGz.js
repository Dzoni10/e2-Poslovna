<<<<<<<< HEAD:PoslovnaProjekat/deployment/web/dist/ListAttributeProperty-BGCislj4.js
import { asProperty, fromConstant$, ensureAttributeId, registerAttributeType, getEntityMeta, registerFilterAttribute, LogManager, getAttribute$, fromComputation$, flatMapL, Access, toFriendlyId, unavailable, available, getOrElseL, asReloadable$, getObjectsByPath$, getObjectByPath$ } from './index-JDXCDs53.js';
import { registerSortingAttribute, listItemProperty } from './CTcC6PjV-Zoc9mpUp.js';
import { createFormatter, createUniverse } from './D5tDSKpV-NCto3GtK.js';
import './ActionButton-CnZtpka2.js';
import './uEIG9e6s-D5bs4rlT.js';
========
import { asProperty, fromConstant$, isOffline, ensureAttributeId, registerAttributeType, getEntityMeta, registerFilterAttribute, LogManager, getAttribute$, fromComputation$, flatMapL, Access, toFriendlyId, unavailable, available, getOrElseL, asReloadable$, getObjectsByPath$, getObjectByPath$ } from './index-DRM94Sf-.js';
import { registerSortingAttribute, listItemProperty } from './XQdQuDNG-BIL054Xu.js';
import { createFormatter, createUniverse } from './77kgvjgm-Ckrt0mx6.js';
import './ActionButton-Vn_V_FOy.js';
import './BkqAssms-a3v8x28y.js';
>>>>>>>> feat/sales-domain:PoslovnaProjekat/deployment/web/dist/ListAttributeProperty-BRLhJBGz.js
